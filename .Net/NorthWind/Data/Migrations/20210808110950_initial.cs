...
namespace Data.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CustomerGroupThresholds",
                columns: table => new
                {
                    CustomerGroupName = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
                    RangeBottom = table.Column<decimal>(type: "money", nullable: true),
                    RangeTop = table.Column<decimal>(type: "money", nullable: true)
                },
                constraints: table =>
                {
                });
