...
namespace Data.Concrete.EfCore.Contexts
{
    public partial class NorthWindContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=DESKTOP-U6PGBQU\\ADMINSQL;Database=NorthWind;Trusted_Connection=True;").UseLoggerFactory(loggerFactory);
            //optionsBuilder.UseNpgsql("Server=89.19.10.194;Port=5432;Database=Vera;User ID=postgres;Password=1234;");
        }
